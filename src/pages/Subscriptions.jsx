...
function Subscriptions({ showUsers, showContent, setPosts, showListOfUsers,
    users, posts, sortType, handleSortTypeChange, renderProfileImages, unsubscribeFromUser,
    loginToken, handleAlertMessage, fetchUserList, userId }) {
                            ...
                            {users ? users.map((user) => (
                                    <article className='user' key={user.id} id={user.id}>
                                        ...
                                        <span>
                                            ...
                                            <button onClick={handleUnsubscribe} className='unsubscribe'>Unsubscribe</button>
                                        </span>
                                    </article>
                            )) : ''}
                            </>
